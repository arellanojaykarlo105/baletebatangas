...
({} as __VLS_IntrinsicElements).h1;
const __VLS_7 = __VLS_6({ ...{}, class: ("text-4xl font-bold ml-8 mt-10"), }, ...__VLS_functionalComponentArgsRest(__VLS_6));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_5, typeof __VLS_7> & Record<string, unknown>) => void)({ ...{}, class: ("text-4xl font-bold ml-8 mt-10"), });
...
({} as __VLS_IntrinsicElements).div;
const __VLS_12 = __VLS_11({ ...{}, class: ("bg-green-600 rounded-lg p-5 m-5 text-white"), }, ...__VLS_functionalComponentArgsRest(__VLS_11));
({} as (props: __VLS_FunctionalComponentProps<typeof __VLS_10, typeof __VLS_12> & Record<string, unknown>) => void)({ ...{}, class: ("bg-green-600 rounded-lg p-5 m-5 text-white"), });
